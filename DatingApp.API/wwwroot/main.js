...
var AuthGuard = /** @class */ (function () {
    function AuthGuard(authService, toastr, router) {
    ...
    AuthGuard = __decorate([
        ...
        __metadata("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"],
...
var ListsResolver = /** @class */ (function () {
    function ListsResolver(userService, router, toastrService) {
    ...
    ListsResolver.prototype.resolve = function (route) {
        ...
        return this.userService.getUsers(this.pageNumber, this.pageSize, null, this.likesParam).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) {
            _this.toastrService.error('problem retrieving data', 'Retreiveng ERROR');
...
var MemberDetailResolver = /** @class */ (function () {
    function MemberDetailResolver(userService, router, toastrService) {
        this.userService = userService;
        this.router = router;
        this.toastrService = toastrService;
    }
    MemberDetailResolver.prototype.resolve = function (route) {
        ...
        return this.userService.getUser(route.params['id']).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) {
            _this.toastrService.error('problem retrieving data', 'Retriving ERROR');
...
var MemberEditResolver = /** @class */ (function () {
    function MemberEditResolver(userService, router, authService, toastrService) {
        this.userService = userService;
        this.router = router;
        this.authService = authService;
        this.toastrService = toastrService;
    ...
    MemberEditResolver.prototype.resolve = function (route) {
        ...
        return this.userService.getUser(this.authService.decodedToken.nameid).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) {
            _this.toastrService.error('problem retrieving your data', 'Retieving ERROR');
            _this.router.navigate(['/members']);
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    MemberEditResolver = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"],
...
var MemberListResolver = /** @class */ (function () {
    function MemberListResolver(userService, router, toastrService) {
        this.userService = userService;
        this.router = router;
        this.toastrService = toastrService;
        this.pageNumber = 1;
...
var MessagesResolver = /** @class */ (function () {
    function MessagesResolver(userService, authService, router, toastrService) {
        this.userService = userService;
        this.authService = authService;
        this.router = router;
        this.toastrService = toastrService;
    ...
    MessagesResolver.prototype.resolve = function (route) {
        ...
        return this.userService.getMessages(this.authService.decodedToken.nameid, this.pageNumber, this.pageSize, this.messageContainer).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) {
            _this.toastrService.error('problem retrieving messages', 'Retreiveng ERROR');
            _this.router.navigate(['/home']);
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    ...
    AuthService.prototype.login = function (model) {
        ...
        return this.http.post(this.baseUrl + 'login', model)
            ...
            if (user) {
                ...
                _this.decodedToken = _this.jwtHelper.decodeToken(user.token); // this line just make the token readable
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getUsers = function (page, itemsPerPage, userParams, likesParam) {
        ...
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"](); // Http header params Data
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _resolvers_lists_resolver__WEBPACK_IMPORTED_MODULE_34__["ListsResolver"],
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.cancelRegisterMode = function (regisertMode) {
...
var ListsComponent = /** @class */ (function () {
    function ListsComponent(authService, userService, route, toastr) {
        this.authService = authService;
        this.userService = userService;
        this.route = route;
        this.toastr = toastr;
...
var MemberCardComponent = /** @class */ (function () {
    function MemberCardComponent(authService, userService, toaster) {
        this.authService = authService;
        this.userService = userService;
    ...
    MemberCardComponent.prototype.sendLike = function (id) {
        ...
        this.userService.sendLike(this.authService.decodedToken.nameid, id).subscribe(function (data) {
            _this.toaster.success('you Have Liked: ' + _this.user.knownAs, 'Success');
        }, function (error) {
...
var MemberDetailComponent = /** @class */ (function () {
    function MemberDetailComponent(userService, toastr, route) {
        this.userService = userService;
        this.toastr = toastr;
        this.route = route;
    }
    MemberDetailComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            var selctedTab = params['tab'];
            _this.membersTab.tabs[selctedTab > 0 ? selctedTab : 0].active = true;
        });
        this.galleryOptions = [
            {
                width: '500px',
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('membersTab'),
        __metadata("design:type", ngx_bootstrap__WEBPACK_IMPORTED_MODULE_5__["TabsetComponent"])
    ], MemberDetailComponent.prototype, "membersTab", void 0);
    MemberDetailComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"], ngx_toastr__WEBPACK_IMPORTED_MODULE_2__["ToastrService"],
...
var MemberEditComponent = /** @class */ (function () {
    function MemberEditComponent(router, toaster, userService, authService) {
        this.router = router;
        this.toaster = toaster;
        this.userService = userService;
        this.authService = authService;
    ...
    MemberEditComponent.prototype.updateUser = function () {
        ...
        this.userService.updateUser(this.authService.decodedToken.nameid, this.user).subscribe(function (next) {
            _this.toaster.success('Profile Updated Successfully', 'Success');
            _this.editForm.reset(_this.user); // reset the user data afte make changes
        }, function (error) {
            _this.toaster.error('Something Error', 'ERROR');
        });
...
var MemberListComponent = /** @class */ (function () {
    function MemberListComponent(userService, toastr, route) {
        this.userService = userService;
        this.toastr = toastr;
        this.route = route;
    ...
    MemberListComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"], ngx_toastr__WEBPACK_IMPORTED_MODULE_2__["ToastrService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]])
    ], MemberListComponent);
...
var MemberMessagesComponent = /** @class */ (function () {
    function MemberMessagesComponent(authService, userService, toastr) {
        this.authService = authService;
        this.userService = userService;
        this.toastr = toastr;
        this.newMessage = {};
...
var PhotoEditorComponent = /** @class */ (function () {
    function PhotoEditorComponent(authService, userService, toastrService, alertify) {
        this.authService = authService;
        this.userService = userService;
        this.toastrService = toastrService;
    ...
    PhotoEditorComponent.prototype.initializeUploder = function () {
        var _this = this;
        ...
        this.uploader.onSuccessItem = function (item, response, status, headers) {
            if (response) {
                var res = JSON.parse(response); // convetr the string to json file
                var photo = {
                    id: res.id,
                    url: res.url,
    ...
    PhotoEditorComponent.prototype.setMainPhoto = function (photo) {
        ...
        this.userService.setMainPhoto(this.authService.decodedToken.nameid, photo.id).subscribe(function () {
            ...
            _this.toastrService.error(' Error', 'Photo Setting ERROR');
        });
    };
    PhotoEditorComponent.prototype.deletePhoto = function (id) {
        ...
        this.userService.deletePhoto(this.authService.decodedToken.nameid, id).subscribe(function () {
            ...
            _this.toastrService.success('Photo Has been Deleted', 'DELETED');
        }, function (error) {
            _this.toastrService.error('Faild to Delete The Photo', 'FAIELD MASSAGE');
        });
        //  });
    };
    __decorate([
    ...
    PhotoEditorComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"], src_app_services_user_service__WEBPACK_IMPORTED_MODULE_4__["UserService"],
            ngx_toastr__WEBPACK_IMPORTED_MODULE_5__["ToastrService"], src_app_services_alertify_service__WEBPACK_IMPORTED_MODULE_6__["AlertifyService"]])
...
var MessagesComponent = /** @class */ (function () {
    function MessagesComponent(authService, userService, route, toastr) {
        this.authService = authService;
        this.userService = userService;
        this.route = route;
        this.toastr = toastr;
    ...
    MessagesComponent.prototype.deleteMessage = function (id) {
        ...
        this.userService.deleteMessage(id, this.authService.decodedToken.nameid)
            ...
            _this.toastr.success('Message has been deleted', 'Deleting Message');
        }, function (error) {
            _this.toastr.error('Message Failed to Delete', 'Failed Deleting');
        });
    };
...
var NavComponent = /** @class */ (function () {
    function NavComponent(authService, alertify, toastr, router) {
        this.authService = authService;
        this.alertify = alertify;
        this.toastr = toastr;
        this.router = router;
    ...
    NavComponent.prototype.login = function () {
        ...
        this.authService.login(this.model).subscribe(function (next) {
            _this.toastr.success('ALERT:login sucssfully', 'Success');
            // this.alertify.success(':ALERT:login sucssfully');
            // console.log('login sucssfully');
        }, function (error) {
            _this.toastr.warning('Login Failed', 'Faulier');
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(authService, alertify, toastr, fb, router) {
        this.authService = authService;
        this.alertify = alertify;
        this.toastr = toastr;
        this.fb = fb;
    ...
    RegisterComponent.prototype.register = function () {
        ...
        if (this.registerForm.valid) {
            ...
            this.authService.register(this.user).subscribe(function () {
                _this.toastr.success('ALERT: Registeration Sucsseffly', 'success');
            }, function (error) {
                _this.toastr.error('password or user Name have problem', 'Error');
            }, function () {
    ...
    RegisterComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"], _services_alertify_service__WEBPACK_IMPORTED_MODULE_2__["AlertifyService"],
            ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]])
    ], RegisterComponent);
...
module.exports = __webpack_require__(/*! /home/abood/DatingApplicationAfterPublisherProject/DatingApp-SPA/src/main.ts */"./src/main.ts");
